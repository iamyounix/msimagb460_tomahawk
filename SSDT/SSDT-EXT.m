 ...
 * depending on the operating system that is running on the system. Overall, the
 * purpose of this code is to provide the operating system with information
 * about the hardware and software configuration of the system and to define
 * methods for controlling and managing power and configuration settings on the
 * system.
 */

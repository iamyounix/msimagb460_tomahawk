...
{0x03})}
Return(Package(0x04)
{"No-hda-gfx",Buffer(0x08)
{0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00},"No-idle-support",Buffer(One)
{0x00}})}
Method(_STA,0,NotSerialized)
{If(_OSI("Darwin"))
{Return(0x0F)}
...
{0x03})}
Return(Package(0x0A)
{"device_type","Non-Volatile memory controller","model","KINGSTON SA2000M8500G","name","ANS0","device-id",Buffer(0x04)
{0x06,0xA8,0x00,0x00},"vendor-id",Buffer(0x04)
{0x4D,0x14,0x00,0x00}})}}}
Scope(RP20)
{Scope(PXSX)
{Method(_STA,0,NotSerialized)
...
{0x03})}
Return(Package(0x0A)
{"device_type","Non-Volatile memory controller","model","KINGSTON SA2000M8500G","name","ANS1","device-id",Buffer(0x04)
{0x06,0xA8,0x00,0x00},"vendor-id",Buffer(0x04)
{0x4D,0x14,0x00,0x00}})}}}
Scope(SAT0)
{Method(_STA,0,NotSerialized)
...
{0x03})}
Return(Package(0x08)
{"kUSBSleepPowerSupply",0x13EC,"kUSBSleepPortCurrentLimit",0x0834,"kUSBWakePowerSupply",0x13EC,"kUSBWakePortCurrentLimit",0x0834})}
Method(_STA,0,NotSerialized)
{If(_OSI("Darwin"))
{Return(0x0F)}
Else

 ...
 *
 * Disassembly of SSDT-2.aml, Wed Jun  7 02:15:34 2023
 *
...
DefinitionBlock ("", "SSDT", 2, "Intel", "PegSsdt", 0x00001000)
{
    ...
    External (_SB_.PCI0.PEG0.PPRW, MethodObj)    // 0 Arguments (from opcode)
    ...
    External (_SB_.PCI0.PEG1.PPRW, MethodObj)    // 0 Arguments (from opcode)

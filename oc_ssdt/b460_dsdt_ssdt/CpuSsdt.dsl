 ...
 *
 * Disassembly of SSDT.aml, Wed Jun  7 02:15:34 2023
 *
...
DefinitionBlock ("", "SSDT", 2, "CpuRef", "CpuSsdt", 0x00003000)
{
    ...
    {
        Name (CTPC, Zero)
        OperationRegion (PNVS, SystemMemory, 0x79EE9000, 0x0074)
    ...
    Scope (\_SB.PR00)
    {
        ...
        Method (GCAP, 1, Serialized)
        {
            ...
            If (LAnd (LEqual (\_SB.ITBM, One), And (\_SB.CFGD, 0x00400000)))
            {
                If (LAnd (LAnd (LNotEqual (\_SB.ITBP, Zero), And (\_SB.OSCP, 0x1000)), LEqual (\_SB.OCLK, Zero)))
                {
                    Store (ITBS, IOB2)
                }
            }
    ...
    Scope (\_SB.PR16)
    {
        ...
        Method (GCAP, 1, NotSerialized)
        {
            ...
            If (LOr (LEqual (ST16, 0x06), LEqual (ST16, 0x0A)))
            {
                Return (Zero)
            }
            ...
            If (And (ST16, One))
            {
                And (ST16, 0x0BFF, CP16)
                Return (Zero)
            }

            Or (And (PC16, 0x7FFFFFFF), CP16, PC16)
            If (LEqual (And (PC16, 0x09), 0x09))
            {
                \_SB.PR01.APPT ()
            }
            ...
            If (LOr (LEqual (And (PC16, 0x09), 0x09), And (\_SB.OSCP, 0x20)))
            {
                \_SB.PR01.APPS ()
            }
    ...
    Scope (\_SB.PR17)
    {
        ...
        Method (GCAP, 1, NotSerialized)
        {
            ...
            If (LOr (LEqual (ST17, 0x06), LEqual (ST17, 0x0A)))
            {
                Return (Zero)
            }
            ...
            If (And (ST17, One))
            {
                And (ST17, 0x0BFF, CP17)
                Return (Zero)
            }

            Or (And (PC17, 0x7FFFFFFF), CP17, PC17)
            If (LEqual (And (PC17, 0x09), 0x09))
            {
                \_SB.PR01.APPT ()
            }
            ...
            If (LOr (LEqual (And (PC17, 0x09), 0x09), And (\_SB.OSCP, 0x20)))
            {
                \_SB.PR01.APPS ()
            }
    ...
    Scope (\_SB.PR18)
    {
        ...
        Method (GCAP, 1, NotSerialized)
        {
            ...
            If (LOr (LEqual (ST18, 0x06), LEqual (ST18, 0x0A)))
            {
                Return (Zero)
            }
            ...
            If (And (ST18, One))
            {
                And (ST18, 0x0BFF, CP18)
                Return (Zero)
            }

            Or (And (PC18, 0x7FFFFFFF), CP18, PC18)
            If (LEqual (And (PC18, 0x09), 0x09))
            {
                \_SB.PR01.APPT ()
            }
            ...
            If (LOr (LEqual (And (PC18, 0x09), 0x09), And (\_SB.OSCP, 0x20)))
            {
                \_SB.PR01.APPS ()
            }
    ...
    Scope (\_SB.PR19)
    {
        ...
        Method (GCAP, 1, NotSerialized)
        {
            ...
            If (LOr (LEqual (ST19, 0x06), LEqual (ST19, 0x0A)))
            {
                Return (Zero)
            }
            ...
            If (And (ST19, One))
            {
                And (ST19, 0x0BFF, CP19)
                Return (Zero)
            }

            Or (And (PC19, 0x7FFFFFFF), CP19, PC19)
            If (LEqual (And (PC19, 0x09), 0x09))
            {
                \_SB.PR01.APPT ()
            }
            ...
            If (LOr (LEqual (And (PC19, 0x09), 0x09), And (\_SB.OSCP, 0x20)))
            {
                \_SB.PR01.APPS ()
            }
        ...
        If (LEqual (TXTE, One))
        {
            Device (ACM)
            {
                ...
                Method (_CID, 0, NotSerialized)  // _CID: Compatible ID
                {
                    ...
                    If (LAnd (LEqual (Local0, 0x000A0650), LNotEqual (CPID, 0x000A0652)))
                    {

			...
			Device (IGPU)
			{
				...
				Method (_DSM, 4, NotSerialized)  // _DSM: Device-Specific Method
				{
					...
					Return (Package ()
					{
						...
						Buffer ()
						{
							 0x53, 0x6C, 0x6F, 0x74, 0x2D, 0x20, 0x30, 
						},  
						"built-in", 
						Zero,
						"device-id",
				...
				Device (XHC2)
				{
					...
					Method (_DSM, 4, NotSerialized)  // _DSM: Device-Specific Method
					{
						...
						Return (Package ()
						{
							...
							Buffer ()
							{
								 0x56, 0x4C, 0x38, 0x30, 0x35, 0x2F, 0x38, 0x30, 0x36, 0x20, 0x78, 0x48, 0x43, 0x49, 0x20, 0x55, 0x53, 0x42, 0x20, 0x33, 0x2E, 0x30, 0x20, 0x43, 0x6F, 0x6E, 0x74, 0x72, 0x6F, 0x6C, 0x6C, 0x65, 0x72, 
							}, 
						})
					}
				...
				Device (ANS0)
				{
					...
					Method (_DSM, 4, NotSerialized)  // _DSM: Device-Specific Method
					{
						...
						Return (Package ()
						{
                           ...
                           Buffer ()
							{
								 0x4E, 0x6F, 0x6E, 0x2D, 0x56, 0x6F, 0x6C, 0x61, 0x74, 0x69, 0x6C, 0x65, 0x20, 0x6D, 0x65, 0x6D, 0x6F, 0x72, 0x79, 0x20, 0x63, 0x6F, 0x6E, 0x74, 0x72, 0x6F, 0x6C, 0x6C, 0x65, 0x72,                           // ....
							}, 
							"model",
                           Buffer ()
							{
								 0x4B, 0x49, 0x4E, 0x47, 0x53, 0x54, 0x4F, 0x4E, 0x20, 0x53, 0x41, 0x32, 0x30, 0x30, 0x30, 0x4D, 0x38, 0x35, 0x30, 0x30, 0x47,                           
							}, 
							"device-id", 
							Buffer (0x04)
							{
				...
				Device (ARPT)
				{
					...
					Method (_DSM, 4, NotSerialized)  // _DSM: Device-Specific Method
					{
						...
						Return (Package ()
						{
							...
							Buffer ()
							{
								 0x42, 0x43, 0x4D, 0x34, 0x33, 0x36, 0x30, 0x20, 0x38, 0x30, 0x32, 0x2E, 0x31, 0x31, 0x61, 0x63, 0x20, 0x57, 0x69, 0x72, 0x65, 0x6C, 0x65, 0x73, 0x73, 0x20, 0x4E, 0x65, 0x74, 0x77, 0x6F, 0x72, 0x6B, 0x20, 0x41, 0x64, 0x61, 0x70, 0x74, 0x65, 0x72, 
							}
						})
					}
				}

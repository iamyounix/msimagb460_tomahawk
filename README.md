...
> **Note**: Here is our device [detail](Devices/Slot.md) dumped via linux. For proper `AAPL,slot-name` placement, open Windows PowerShell and paste this code in terminal. `Get-WmiObject -class "Win32_SystemSlot"`.

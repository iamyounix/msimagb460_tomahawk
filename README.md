...
**Note:** [**Installer Guide**](https://dortania.github.io/OpenCore-Install-Guide/installer-guide/), is the most important part. There is an option to create a USB installation using a different OS. Do note, **Windows** and **Linux** methods using the **com.apple.recovery.boot** require online installation. Make sure your **Ethernet** is working. If not, make sure you have:

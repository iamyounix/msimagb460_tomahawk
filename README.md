...
- As mention above, this build uses the Intel i5 10400, which is the Comet Lake variant. A little addition is needed. We start with SSDT. The required SSDT is:
...
- OSI placement is an important aspect to upgrade SSDT. Here's an example of regular vs optimized.

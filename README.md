...
> Note: Start from **macOS 12.3**, `SSDT-PLUG.aml` or `plugin-type=1` is not required. The "x86PlatformPlugin" is enabled by default in macOS 12.3+. Refer [Dortania/Bugtracker Issue #269](https://github.com/dortania/bugtracker/issues/269). 
